...
var opened_from_pause = false  # track where settings was opened
...
func _on_slider_changed(setting_name: String, value: float):
	# find value label by searching in panel
...
# helper func to find node by name repeatedly
...
func update_settings_display():
	# update sliders using helper func
